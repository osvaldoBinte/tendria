...
class LanguageController extends GetxController {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'Español': {
      ...
      'travel_mode_active_desc': 'Estás viendo perfiles de otra ciudad',
      'travel_mode_deactivated': 'Modo viaje desactivado',
      'deactivate': 'Desactivar',
      'search_city_title': 'Buscar ciudad',
      'search_city_hint': 'Escribe el nombre de una ciudad...',
      'search_city_prompt': 'Escribe para buscar ciudades',
      'search_city_no_results': 'Sin resultados',
      'search_city_btn': 'Buscar en otra ciudad',
      ...
      //SelfieCameraResult
      'selfie_place_face': 'Coloca tu rostro en el círculo',
      'selfie_face_detected': 'Rostro detectado, mantente quieto...',
      'selfie_no_move_3': '¡No te muevas! Tomando foto en 3...',
      'selfie_no_move_2': '¡No te muevas! Tomando foto en 2...',
      'selfie_no_move_1': '¡No te muevas! Tomando foto en 1...',
      'selfie_moved': '⚠️ Moviste la cara, vuelve a colocarla',
      'selfie_taking': '📸 Tomando foto...',
      'selfie_ready': '¡Selfie lista!',
      'selfie_error': 'Error al tomar la foto, intenta de nuevo',
      'selfie_no_front_camera': 'No se encontró cámara frontal',
      'selfie_camera_error': 'Error al iniciar la cámara',
      'selfie_auto_detection': 'Detección automática',
      'selfie_retake': 'Repetir',
      'selfie_use': 'Usar esta foto',
      'selfie_not_detected': 'No te detectamos, toca para fotografiar',

      // VerificationPage
      'verify_title': 'Verificación',
      'verify_profile_verified': 'Tu perfil verificado',
      'verify_profile_desc': 'Genera más confianza y consigue más matches',
      'verify_completed': 'de 3 verificaciones completadas',
      'verify_selfie_title': 'Selfie',
      'verify_selfie_subtitle': 'Verifica que eres una persona real',
      'verify_phone_title': 'Teléfono',
      'verify_phone_subtitle': 'Confirma tu número de teléfono',
      'verify_social_title': 'Red social',
      'verify_social_subtitle': 'Vincula tu cuenta de redes sociales',
      'verify_status_verified': 'Verificado',
      'verify_status_pending': 'En revisión',
      'verify_status_none': 'Sin verificar',
      'verify_selfie_sent': 'Selfie enviada',
      'verify_benefits_title': '¿Por qué verificarte?',
      'verify_benefit1_title': 'Más matches',
      'verify_benefit1_desc':
          'Los perfiles verificados reciben hasta 3x más likes',
      'verify_benefit2_title': 'Mayor confianza',
      'verify_benefit2_desc':
          'Los usuarios confían más en perfiles verificados',
      'verify_benefit3_title': 'Destacado en búsquedas',
      'verify_benefit3_desc': 'Aparece antes en los resultados del radar',
      'verify_phone_sheet_title': 'Verificar teléfono',
      'verify_phone_country_label': 'País *',
      'verify_phone_country_hint': 'Selecciona tu país',
      'verify_phone_number_label': 'Número de teléfono *',
      'verify_phone_number_hint': '123 456 7890',
      'verify_send_btn': 'Enviar para verificación',
      'verify_country_picker_title': 'Selecciona tu país',
      'verify_country_search_hint': 'Buscar país...',
      'verify_social_sheet_title': 'Verificar red social',
      'verify_social_network_label': 'Red social',
      'verify_username_label': 'Nombre de usuario',
      'verify_username_hint': '@tuusuario',
      'verify_url_generated': 'URL generada',
      'verify_view_profile': 'Ver perfil',
      'verify_view_profile_hint':
          'Toca "Ver perfil" para confirmar que es tu cuenta',
      'verify_selfie_sheet_title': 'Verificar con selfie',
      'verify_profile_photo_label': 'Tu foto de perfil',
      'verify_selfie_label': 'Tu selfie',
      'verify_add_photo': 'Agregar foto',
      'verify_photo_required': 'Requerida para la selfie',
      'verify_change_photo': 'Cambiar',
      'verify_take_selfie': 'Tomar selfie',
      'verify_retake': 'Tomar otra',
      'verify_selfie_info':
          'Asegúrate de que tu rostro sea claramente visible y coincida con tu foto de perfil.',
      'verify_send_selfie': 'Enviar selfie',

      'verify_load_error': 'No se pudieron cargar las verificaciones',
      'verify_phone_empty': 'Ingresa tu número de teléfono',
      'verify_country_empty': 'Selecciona tu país',
      'verify_phone_success': 'Teléfono enviado para verificación',
      'verify_username_empty': 'Ingresa tu nombre de usuario primero',
      'verify_url_error': 'La URL no se pudo generar',
      'verify_social_success': 'Red social enviada para verificación',
      'verify_browser_error': 'No se pudo abrir el navegador',
      'verify_selfie_empty': 'Toma una selfie primero',
      'verify_no_profile_photo': 'No tienes foto de perfil configurada',
      'verify_selfie_success': 'Selfie enviada para verificación',

      'verify_gate_title': 'Verifica tu perfil para usar el radar',
      'verify_gate_desc':
          'Necesitas completar todas las verificaciones antes de buscar personas cercanas.',
      'verify_gate_btn': 'Verificar mi perfil',
      'verify_gate_not_verified': 'Sin verificar',

      //cupon google
      'purchase_title': 'Adquirir Créditos',
      'purchase_subtitle':
          'Agrega créditos a tu cuenta y desbloquea más conexiones.',
      'purchase_payment_method': 'Método de pago:',
      'purchase_buy_btn': 'Comprar',
      'purchase_empty_title': 'Sin productos disponibles',
      'purchase_retry': 'Reintentar',
      'purchase_coupon_label': 'Cupón de descuento (opcional)',
      'purchase_coupon_hint': 'Ej: DESCUENTO20',
      'purchase_coupon_applied': 'Cupón aplicado al realizar la compra',
      'purchase_credits': 'créditos',
      'purchase_no_device': 'Compras no disponibles en este dispositivo',
      'purchase_in_progress': 'Ya hay una compra en progreso',
      'purchase_product_not_found': 'Producto no encontrado en la tienda',
      'purchase_load_error': 'Error al cargar los productos',
      'purchase_error': 'Error al iniciar la compra',
      'purchase_stream_error': 'Error en el proceso de compra',
      'purchase_processing': 'Procesando compra...',
      'purchase_canceled': 'Compra cancelada',
      'purchase_verify_error': 'Error al verificar la compra con el servidor',
      'purchase_internal_error': 'Error interno al procesar la compra',
      'purchase_success': '¡Compra completada exitosamente!',
      'purchase_appstore': 'App Store',
      'purchase_googleplay': 'Google Play',
      'coupon_valid': 'Cupón válido',
      'coupon_invalid': 'Código de cupón no válido',
      'coupon_validate_error': 'Error al validar el cupón',
      'coupon_must_validate': 'Valida el cupón antes de continuar',
      'coupon_bonus': 'créditos extra con este cupón',

      //QRScannerWidget
      'qr_scan_title': 'ESCANEAR CUPÓN',
      'qr_scan_description': 'Apunta al código QR del cupón para aplicarlo',
      'qr_scan_default_title': 'ESCANEAR QR',
      'qr_scan_default_description': 'Escanea el código QR',
      'qr_scan_instruction':
          'Coloca el código QR dentro del marco y mantén estable el dispositivo',
      'qr_scan_torch_off': 'Apagar',
      'qr_scan_torch_on': 'Linterna',
      'qr_scan_switch_camera': 'Cambiar',
      'qr_scan_cancel': 'CANCELAR ESCANEO',
      'qr_scan_restart_camera': 'Reiniciar cámara',
      'qr_scan_camera_error': 'Error de cámara',
    },
    'Inglés': {
      // ── UpdateProfilePage ──────────────────────────
      'age_range': 'Age Range',
      ...
      'travel_mode_active_desc': 'You\'re viewing profiles from another city',
      'travel_mode_deactivated': 'Travel mode deactivated',
      'deactivate': 'Deactivate',
      'search_city_title': 'Search city',
      'search_city_hint': 'Type a city name...',
      'search_city_prompt': 'Type to search cities',
      'search_city_no_results': 'No results found',
      'search_city_btn': 'Search in another city',
      ...
      //SelfieCameraResult
      'selfie_place_face': 'Place your face in the circle',
      'selfie_face_detected': 'Face detected, stay still...',
      'selfie_no_move_3': 'Don\'t move! Taking photo in 3...',
      'selfie_no_move_2': 'Don\'t move! Taking photo in 2...',
      'selfie_no_move_1': 'Don\'t move! Taking photo in 1...',
      'selfie_moved': '⚠️ You moved, place your face again',
      'selfie_taking': '📸 Taking photo...',
      'selfie_ready': 'Selfie ready!',
      'selfie_error': 'Error taking photo, try again',
      'selfie_no_front_camera': 'Front camera not found',
      'selfie_camera_error': 'Error starting camera',
      'selfie_auto_detection': 'Automatic detection',
      'selfie_retake': 'Retake',
      'selfie_use': 'Use this photo',
      'selfie_not_detected': 'We can\'t detect you, tap to take photo',

      // VerificationPage
      'verify_title': 'Verification',
      'verify_profile_verified': 'Your verified profile',
      'verify_profile_desc': 'Build trust and get more matches',
      'verify_completed': 'of 3 verifications completed',
      'verify_selfie_title': 'Selfie',
      'verify_selfie_subtitle': 'Verify you are a real person',
      'verify_phone_title': 'Phone',
      'verify_phone_subtitle': 'Confirm your phone number',
      'verify_social_title': 'Social network',
      'verify_social_subtitle': 'Link your social media account',
      'verify_status_verified': 'Verified',
      'verify_status_pending': 'Under review',
      'verify_status_none': 'Not verified',
      'verify_selfie_sent': 'Selfie sent',
      'verify_benefits_title': 'Why verify yourself?',
      'verify_benefit1_title': 'More matches',
      'verify_benefit1_desc': 'Verified profiles get up to 3x more likes',
      'verify_benefit2_title': 'More trust',
      'verify_benefit2_desc': 'Users trust verified profiles more',
      'verify_benefit3_title': 'Featured in searches',
      'verify_benefit3_desc': 'Appear first in radar results',
      'verify_phone_sheet_title': 'Verify phone',
      'verify_phone_country_label': 'Country *',
      'verify_phone_country_hint': 'Select your country',
      'verify_phone_number_label': 'Phone number *',
      'verify_phone_number_hint': '123 456 7890',
      'verify_send_btn': 'Send for verification',
      'verify_country_picker_title': 'Select your country',
      'verify_country_search_hint': 'Search country...',
      'verify_social_sheet_title': 'Verify social network',
      'verify_social_network_label': 'Social network',
      'verify_username_label': 'Username',
      'verify_username_hint': '@yourusername',
      'verify_url_generated': 'Generated URL',
      'verify_view_profile': 'View profile',
      'verify_view_profile_hint':
          'Tap "View profile" to confirm it\'s your account',
      'verify_selfie_sheet_title': 'Verify with selfie',
      'verify_profile_photo_label': 'Your profile photo',
      'verify_selfie_label': 'Your selfie',
      'verify_add_photo': 'Add photo',
      'verify_photo_required': 'Required for selfie',
      'verify_change_photo': 'Change',
      'verify_take_selfie': 'Take selfie',
      'verify_retake': 'Take another',
      'verify_selfie_info':
          'Make sure your face is clearly visible and matches your profile photo.',
      'verify_send_selfie': 'Send selfie',
      'verify_load_error': 'Could not load verifications',
      'verify_phone_empty': 'Enter your phone number',
      'verify_country_empty': 'Select your country',
      'verify_phone_success': 'Phone sent for verification',
      'verify_username_empty': 'Enter your username first',
      'verify_url_error': 'URL could not be generated',
      'verify_social_success': 'Social network sent for verification',
      'verify_browser_error': 'Could not open browser',
      'verify_selfie_empty': 'Take a selfie first',
      'verify_no_profile_photo': 'You have no profile photo set',
      'verify_selfie_success': 'Selfie sent for verification',
      'verify_gate_title': 'Verify your profile to use the radar',
      'verify_gate_desc':
          'You need to complete all verifications before searching for nearby people.',
      'verify_gate_btn': 'Verify my profile',
      'verify_gate_not_verified': 'Not verified',

      //cupon google
      'purchase_title': 'Get Credits',
      'purchase_subtitle':
          'Add credits to your account and unlock more connections.',
      'purchase_payment_method': 'Payment method:',
      'purchase_buy_btn': 'Buy',
      'purchase_empty_title': 'No products available',
      'purchase_retry': 'Retry',
      'purchase_coupon_label': 'Discount coupon (optional)',
      'purchase_coupon_hint': 'Ex: DISCOUNT20',
      'purchase_coupon_applied': 'Coupon will be applied at checkout',
      'purchase_credits': 'credits',
      'purchase_no_device': 'Purchases not available on this device',
      'purchase_in_progress': 'A purchase is already in progress',
      'purchase_product_not_found': 'Product not found in the store',
      'purchase_load_error': 'Error loading products',
      'purchase_error': 'Error starting purchase',
      'purchase_stream_error': 'Error during purchase process',
      'purchase_processing': 'Processing purchase...',
      'purchase_canceled': 'Purchase canceled',
      'purchase_verify_error': 'Error verifying purchase with server',
      'purchase_internal_error': 'Internal error processing purchase',
      ...
      'coupon_must_validate': 'Validate the coupon before continuing',
      'coupon_bonus': 'extra credits with this coupon',

      //QRScannerWidget
      'qr_scan_title': 'SCAN COUPON',
      'qr_scan_description': 'Point at the coupon QR code to apply it',
      'qr_scan_default_title': 'SCAN QR',
      'qr_scan_default_description': 'Scan the QR code',
      'qr_scan_instruction':
          'Place the QR code inside the frame and keep the device steady',
      'qr_scan_torch_off': 'Turn off',
      'qr_scan_torch_on': 'Torch',
      'qr_scan_switch_camera': 'Switch',
      'qr_scan_cancel': 'CANCEL SCAN',
      'qr_scan_restart_camera': 'Restart camera',
      'qr_scan_camera_error': 'Camera error',
    },
  };
}
