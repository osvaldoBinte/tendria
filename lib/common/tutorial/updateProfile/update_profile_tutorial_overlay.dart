...
import 'update_profile_tutorial_controller.dart';

class UpdateProfileTutorialOverlay extends StatelessWidget {
  const UpdateProfileTutorialOverlay({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ctrl = Get.find<UpdateProfileTutorialController>();
  ...
  Widget _buildTooltip(
    ...
    UpdateProfileTutorialController ctrl,
    UpdateProfileTutorialStep step,
    Rect? targetRect,
  ) {
