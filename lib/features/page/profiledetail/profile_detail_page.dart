...
import 'package:tendria/features/page/profiledetail/profile_detail_controller.dart';
...
class ProfileDetailScreen extends StatelessWidget {
  ...
  Widget _buildSliverAppBar(ProfileDetailController controller) {
    return Obx(
      () => SliverAppBar(
        expandedHeight: 450,
        pinned: true,
                  ...
                  PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Image.network(
                        controller.profile.value.gallery[index],
                        fit: BoxFit.cover,
  ...
  Widget _buildBioSection(ProfileDetailController controller) {
    return Obx(
      () => Container(
  ...
  Widget _buildSobremiSection(ProfileDetailController controller) {
    return Obx(
      () => Container(
        margin: const EdgeInsets.symmetric(horizontal: 16),
        padding: const EdgeInsets.all(16),
  ...
  Widget _buildInterestsSection(ProfileDetailController controller) {
    return Obx(
      () => Container(
        margin: const EdgeInsets.symmetric(horizontal: 16),
        padding: const EdgeInsets.all(16),
  ...
  Widget _buildBuscoSection(ProfileDetailController controller) {
    return Obx(
      () => Container(
        margin: const EdgeInsets.symmetric(horizontal: 16),
        padding: const EdgeInsets.all(16),
...
Widget reporteButtons(ProfileDetailController controller) {
  return Container(
    margin: const EdgeInsets.symmetric(horizontal: 16),
